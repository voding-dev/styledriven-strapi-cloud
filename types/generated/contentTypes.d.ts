...
export interface ApiHomepageRecentWorkHomepageRecentWork
  extends Struct.CollectionTypeSchema {
  collectionName: 'homepage_recent_works';
  info: {
    displayName: 'HomepageRecentWork';
    pluralName: 'homepage-recent-works';
    singularName: 'homepage-recent-work';
  };
  options: {
  ...
  attributes: {
    ...
    client: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::homepage-recent-work.homepage-recent-work'
    > &
      Schema.Attribute.Private;
...
export interface ApiHomepageShowcaseHomepageShowcase
  extends Struct.CollectionTypeSchema {
  collectionName: 'homepage_showcases';
  info: {
    displayName: 'HomepageShowcase';
    pluralName: 'homepage-showcases';
    singularName: 'homepage-showcase';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::homepage-showcase.homepage-showcase'
    > &
      Schema.Attribute.Private;
    position: Schema.Attribute.Integer &
      Schema.Attribute.Required &
